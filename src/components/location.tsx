  ...
  return (
    <section id="locations">
      <div className="bg-black px-3 pb-6 md:pb-24 pt-24">
        ...
        <h1 className="font-bold text-2xl md:text-4xl mt-3 mb-10 md:text-center">
          FIND <span className="text-primary">US</span>
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 md:px-32 gap-6 md:gap-12">
          <iframe
          ...
          <div>
            ...
            <h1 className="font-bold text-xl md:text-3xl md:my-6">
              CABANG CDT
            </h1>
            <h1 className="my-3 bg-primary text-black p-2 rounded-md text-xs font-extrabold w-max tracking-widest">
              FOOD & DRINKS AVAILABLE
            </h1>
            <span className="flex gap-x-2 text-sm text-primary mt-3 md:mt-10">
              <MapPin size={18} />
              <span>
